...
export const PopoverWrapper =React.forwardRef(({questionId, ...props}, ref)=> {
    const dispatch = useDispatch();
    return (
    <Popover id="popover-basic" {...props} ref={ref}>
      <Popover.Title as="h3">Are You sure to delete this question</Popover.Title>
      <Popover.Content>
    ...
    return (
        <div>
            <p style={{fontSize: '1.1rem'}}>
                ...
                onClick={()=>{viewHandler('edit', question.id)}} > Edit </Button>

                <OverlayTrigger trigger="click" placement="bottom" overlay={<PopoverWrapper  questionId={question.id} />} >
