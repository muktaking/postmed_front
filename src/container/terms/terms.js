...
export default function Terms() {
  return (
    <div>
      ...
      <p>Welcome to medionexam!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of allAboutMedical's Website, located at https://medionexam.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use medionexam if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing medionexam, you agreed to use
        cookies in agreement with the allAboutMedical's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, allAboutMedical and/or its licensors own the
        intellectual property rights for all material on medionexam. All
        intellectual property rights are reserved. You may access this from
        medionexam for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from medionexam</li>
        <li>Sell, rent or sub-license material from medionexam</li>
        <li>Reproduce, duplicate or copy material from medionexam</li>
        <li>Redistribute content from medionexam</li>
      </ul>
      ...
      <p>
        ...
        allAboutMedical does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of allAboutMedical,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, allAboutMedical
      ...
      <p>
        allAboutMedical reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant allAboutMedical a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of allAboutMedical; and (d) the
      ...
      <p>
        ...
        e-mail to allAboutMedical. Please include your name, your organization
      ...
      <p>
        No use of allAboutMedical's logo or other artwork will be allowed for
